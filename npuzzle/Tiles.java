...
public class Tiles implements State {
  ...
  public int hashCode() {
    return this.width + 10 * this.emptyTileRow + 100 * this.emptyTileColumn + 1000 * Arrays.stream(this.tiles).sum();
  }
  ...
  public boolean equals(Object otherObject) {
    ...
    Tiles otherTiles = (Tiles) otherObject;
    return (this.width == otherTiles.width && 
            this.emptyTileRow == otherTiles.emptyTileRow &&
            this.emptyTileColumn == otherTiles.emptyTileColumn &&
            Arrays.equals(this.tiles, otherTiles.tiles));
  }
}
